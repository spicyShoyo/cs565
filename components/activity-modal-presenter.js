...
export default class ActivityModalPresenter extends React.Component {
  render() {
    if (this.props.activityInfo) {
      return (
        <View>
              ...
              <View style={styles.modalContainer}>
                ...
                <View style={{marginTop: '40%', width: '100%', flex: 1}}>
                  <View style={ chipStyles.body }>
                    ...
                    <Text style={ chipStyles.statusText}>{ this.props.activityInfo.where }</Text>
                    <Text style={ chipStyles.titleText}>What</Text>
                      { this.props.activityInfo.what.map((item, index) => {
                        return (
